    ...
    <div class="row">
        ...
        <div class="col">
            <div class="card p-3 bg-white">
                <h3 class="text-dark">List of samples Completed</h3>
                <div class="col my-2">
                    <nav class="navbar">
                        <div class="container-fluid p-0">
                            <form class="d-flex" method="GET" action="{{ route('completedSamples') }}">
                            ...
                            {{-- <div class="d-flex gap-2"> --}}
                                <form class="d-flex gap-2" method="GET" action="{{ route('completedSamples') }}">
                ...
                <table id="" class="table table-striped display table-responsive rounded">
                    <thead>
                        <tr>
                            ...
                            <th>Patient Name</th>
                            <th>Date Received</th>
                            <th class="rounded-end-3 ">Completed At</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($samples as $sample)
                            @if ($sample->all_departments_completed) <!-- Only show incomplete samples -->
                                <tr>
                                    ...
                                    <td>{{ Carbon::parse($sample->completed_at)->format('d-m-Y') }}</td>
                                    {{-- <td>
