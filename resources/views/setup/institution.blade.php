            ...
            <div class="col">
                <div class="card p-3 bg-white">
                    ...
                    <div class="col my-2">
                        <nav class="navbar">
                            <div class="container-fluid p-0">
                                <form class="d-flex" method="GET" action="{{ route('institution.index') }}">
                                    ...
                                    <td>
                                        <ul class="list-inline hstack gap-2 mb-0">
                                            <li class="list-inline-item" data-bs-toggle="tooltip"
                                                ...
                                                <a class="edit-item-btn" data-id="{{ $institution->id }}"  href="#showModal" data-bs-toggle="modal"><i
                                                        class="ri-pencil-fill align-bottom text-muted"></i></a>
                                            </li>
                                            <li class="list-inline-item" data-bs-toggle="tooltip"
                                                data-bs-trigger="hover" data-bs-placement="top" title="Delete">
                                                <a class="remove-item-btn" data-id="{{ $institution->id }}"  data-bs-toggle="modal"
                    ...
                    <ul class="pagination justify-content-center">
                        @if ($institutions->previousPageUrl())
                            <li class="page-item previousPageUrl">
                                <a class="page-link" href="{{ $institutions->previousPageUrl() }}" aria-label="Previous">
                        ...
                        @for ($page = 1; $page <= $institutions->lastPage(); $page++)
                            <li class="page-item {{ $institutions->currentPage() == $page ? 'active' : '' }}">
                                <a class="page-link"
                                    href="{{ $institutions->url($page) }}">{{ str_pad($page, 2, '0', STR_PAD_LEFT) }}</a>
                            </li>
                        @endfor

                        @if ($institutions->nextPageUrl())
                            <li class="page-item nextPageUrl">
                                <a class="page-link" href="{{ $institutions->nextPageUrl() }}" aria-label="Next">
    ...
    <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                ...
                <form class="tablelist-form" id="leadtype_form" action="{{ url('/institution') }}" method="Post"
                    autocomplete="off">
                    @csrf
    ...
    <script>
        jQuery(document).ready(function($) {
            ...
            $('.edit-item-btn').on('click', function() {
                ...
                var url = '{{ url('/institution') }}' + '/' + itemId + '/edit';
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#leadtype_form').attr('action', '{{ url('/institution') }}/' +
                            itemId);
