        ...
        <div class="container-fluid align-items-center d-flex justify-content-between">
            <div class="d-flex align-items-center">
                <a class="navbar-brand ms-5" href="#">
                    <img src="<?php echo e(URL::asset('build/images/logo-lis.png')); ?>" alt="" height="50">
                </a>
            ...
            <div class="dropdown ms-sm-3 header-item topbar-user">
                <button type="button" class="btn d-flex align-items-center" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="d-flex align-items-center">
                        <span class="text-end me-2">
                            <span class="d-none d-xl-inline-block ms-1 fw-semibold user-name-text"><?php echo e(Auth::user()->first_name); ?></span>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <a class="dropdown-item" href="javascript:void();" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                        <i class="bx bx-power-off font-size-16 align-middle me-1"></i> <span key="t-logout"><?php echo app('translator')->get('translation.logout'); ?></span>
                    </a>
            ...
            <div class="d-flex border-0">
                ...
                <button type="button" class="btn btn-sm px-3 fs-16 header-item vertical-menu-btn topnav-hamburger" id="topnav-hamburger-icon">
                    <span class="hamburger-icon">
                            <img src="<?php echo e(URL::asset('build/images/left-arrow.png')); ?>" alt="" height="26">
                    </span>
                </button>
            </div>
        </div>
...
<?php /**PATH C:\laragon\www\LIS\LIS\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>