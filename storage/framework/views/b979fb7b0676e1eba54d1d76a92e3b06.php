                ...
                <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                    <ul class="navbar-nav d-flex gap-1 justify-content-center w-100">
                        <li class="nav-item border-nav rounded flex-grow-1">
                            <a class="nav-link sub-link active" aria-current="page" href="<?php echo e(url('/reports/test-reports')); ?>">Find</a>
                        </li>
                        <?php if(!$allTestsCompleted): ?>
                            ...
                            <?php if($testReports->isNotEmpty()): ?>
                                ...
                                <?php if($reporttype == 1): ?> 
                                    ...
                                    ?>
                                        ...
                                        <?php if($hematologyStatus->signed_by ?? false): ?>
                                ...
                                <?php elseif($reporttype == 2): ?> 
                                    ...
                                    ?>
                                        ...
                                        <?php if($cytologyStatus->signed_by ?? false): ?>
                                            <li class="nav-item border-nav rounded flex-grow-1" id="allreadyassign">
                                                <a class="nav-link sub-link " href="#">Signed</a>
                                            </li>
                                        <?php else: ?>
                                ...
                                <?php elseif($reporttype == 3): ?> 
                                    ...
                                    ?>
                                        ...
                                        <?php if($urineStatus->signed_by ?? false): ?>
                                            <li class="nav-item border-nav rounded flex-grow-1" id="allreadyassign">
                                                <a class="nav-link sub-link " href="#">Signed</a>
                                            </li>
                                        <?php else: ?>
                        ...
                        <?php if(!$allTestsCompleted): ?>
                            <li class="nav-item border-nav rounded flex-grow-1" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                ...
                                <a class="nav-link sub-link complete-report-btn" data-id="<?php echo e($sample->id); ?>" data-bs-toggle="modal"
                        ...
                        <?php else: ?>
                            <?php if(auth()->user()->hasRole('admin')): ?>
                                <li class="nav-item border-nav rounded flex-grow-1" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                    data-bs-placement="top" title="Complete">
                                    <a class="nav-link sub-link uncomplete-report-btn" data-id="<?php echo e($sample->id); ?>" data-bs-toggle="modal"
                        ...
                        <li class="nav-item border-nav rounded flex-grow-1">
                            <a class="nav-link sub-link" aria-current="page" id="pdfbtn"
                                href="<?php echo e(url('generate-pdf/'.$sample->id.'/'.$reporttype)); ?>" target="_blank">Generate Pdf Report</a>
                        </li>
                        <li class="nav-item border-nav rounded flex-grow-1">
                            <a class="nav-link sub-link" aria-current="page" id=""
                                href="<?php echo e(url('reports/audit-trails/'.$sample->id.'/'.$reporttype)); ?>">Audit Trail</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <?php if($testReports->isNotEmpty()): ?>
                                ...
                                <div class="col-md-6" id="report_signed_input">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="report_signed"
                                            value="<?php echo e('Report signed by ' . $hematologyStatus->signedBy->first_name . ' on ' . $hematologyStatus->signed_at); ?>"
                                            disabled />
                                    </div>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if($cytologyStatus->signed_by ?? false): ?>
                                <div class="col-md-6" id="report_signed_input">
                                    <div class="form-group">
                                        <label for="access_number" class="form-label">Report Signed By</label>
                                        <input type="text" class="form-control" id="report_signed"
                                            value="<?php echo e('Report signed by ' . $cytologyStatus->signedBy->first_name . ' on ' . $cytologyStatus->signed_at); ?>"
                                            disabled />
                                    </div>
                                </div>
                            <?php endif; ?>
                    ...
                    <?php elseif($reporttype == 3): ?> 
                        ...
                        ?>
                            ...
                            <?php if($urinalysisStatus->signed_by ?? false): ?>
                                <div class="col-md-6" id="report_signed_input">
                                    <div class="form-group">
                                        <label for="access_number" class="form-label">Report Signed By</label>
                                        <input type="text" class="form-control" id="report_signed"
                                            value="<?php echo e('Report signed by ' . $urinalysisStatus->signedBy->first_name.' '. $urinalysisStatus->signedBy->surname . ' on ' . $urinalysisStatus->signed_at); ?>"
                                            disabled />
                                    </div>
                                </div>
                            <?php endif; ?>
                ...
                <?php if($allTestsCompleted): ?>
                    <div class="col-md-6" id="report_signed_input">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="report_signed"
                                value="<?php echo e('Report Completed on ' . $completedat); ?>"
                                disabled />
                        </div>
                    </div>
                <?php endif; ?>
        ...
        <div class="card px-5 py-3 bg-white">
            ...
            <div class="row pt-3">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" id="access_number" name="access_number" class="form-control"
                            value="<?php echo e($sample->patient->surname); ?> <?php echo e($sample->patient->first_name); ?>" disabled />
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" id="access_number" name="access_number" class="form-control"
                            value="<?php echo e($sample->access_number); ?>" disabled />
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" id="collected_date" name="collected_date" class="form-control"
                            value="<?php echo e(Carbon::parse($sample->collected_date)->format('d-m-Y')); ?>" disabled />
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" id="received_date" name="received_date" class="form-control"
                            value="<?php echo e(Carbon::parse($sample->received_date)->format('d-m-Y')); ?>" disabled />
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" id="received_time" name="received_time" class="form-control"
                            value="<?php echo e($sample->received_time); ?>" disabled />
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" id="test_number" name="test_number" class="form-control"
                            value="<?php echo e($sample->bill_to); ?>" disabled />
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" id="doctorname" name="doctorname" class="form-control"
                            value="<?php echo e($sample->doctor->name); ?>" disabled />
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        ?>
                        <input type="text" id="test_number" name="test_number" class="form-control"
                            value="<?php echo e($sampleprofiles  . ', ' . $individualtests); ?>" disabled />
                    </div>
                </div>
            </div>

            <input type="hidden" id="gender" name="gender" value="<?php echo e($sample->patient->sex); ?>">
            <input type="hidden" id="reporttypeis" name="reporttypeis" value="<?php echo e($reporttype); ?>">
            <input type="hidden" id="sampleid" name="sampleid" value="<?php echo e($sample->id); ?>">
                ...
                <div class="row pt-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="note" id="note" cols="30" rows="5" class="form-control"><?php echo e($hematologyStatus->note ?? ''); ?></textarea>
                        ...
                        <?php if($reporttype == '1'): ?>
                            <?php $__currentLoopData = $categorizedTests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $profileId => $profileData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php $__currentLoopData = $profileData['tests']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" data-test-id="<?php echo e($test->id); ?>"
                                                name="tests[<?php echo e($test->id); ?>][id]" class="form-control"
                                                value="<?php echo e($test->id); ?>" hidden disabled />
                                            <input type="text" data-test-id="<?php echo e($test->id); ?>"
                                                name="tests[<?php echo e($test->id); ?>][description]" class="form-control"
                                                value="<?php echo e($test->name); ?>" disabled />
                                        </td>
                                        <td>
                                            <input type="text"  data-test-id="<?php echo e($test->id); ?>"
                                                name="tests[<?php echo e($test->id); ?>][test_results]" class="form-control test-result"
                                                value="<?php echo e($biochemHaemoResults->test_results ?? ''); ?>"
                                                data-basic-low="<?php echo e($test->basic_low_value_ref_range); ?>"
                                                data-basic-high="<?php echo e($test->basic_high_value_ref_range); ?>"
                                                data-male-low="<?php echo e($test->male_low_value_ref_range); ?>"
                                                data-male-high="<?php echo e($test->male_high_value_ref_range); ?>"
                                                data-female-low="<?php echo e($test->female_low_value_ref_range); ?>"
                                                data-female-high="<?php echo e($test->female_high_value_ref_range); ?>"
                                                data-nomanual-set="<?php echo e($test->nomanualvalues_ref_range); ?>" />
                                        </td>
                                        <td>
                                            

                                            <input type="text"  data-test-id="<?php echo e($test->id); ?>"
                                                name="tests[<?php echo e($test->id); ?>][flag]" class="form-control flag-input"
                                                value="<?php echo e($biochemHaemoResults->flag ?? ''); ?>" style="width: 80px;"/>
                                            <?php
                                                $background = '';
                                            ...
                                            ?>
                                            <span class="badge badge-pill flag-badge <?php echo e($background); ?> d-none"
                                                data-key="t-hot"><?php echo e($biochemHaemoResults->flag ?? ''); ?></span>
                                        </td>
                                        <td>
                                            <p class="reference-range">
                                                <?php if($test->reference_range == 'basic_ref'): ?>
                                                    <?php echo e($test->basic_low_value_ref_range . '-' . $test->basic_high_value_ref_range.' '.$test->basic_unit_value_ref_range); ?>

                                                <?php elseif($test->reference_range == 'optional_ref'): ?>
                                                    Male: <?php echo e($test->male_low_value_ref_range . '-' . $test->male_high_value_ref_range.' '.$test->male_unit_value_ref_range); ?>

                                                    <br>
                                                    Female: <?php echo e($test->female_low_value_ref_range . '-' . $test->female_high_value_ref_range.' '.$test->female_unit_value_ref_range); ?>

                                                <?php elseif($test->reference_range == 'no_manual_tag'): ?>
                                                    <?php echo e($test->nomanualvalues_ref_range); ?>

                                                <?php endif; ?>
                                            </p>
                                        </td>
                                        <td>
                                            <textarea data-test-id="<?php echo e($test->id); ?>" name="tests[<?php echo e($test->id); ?>][test_notes]" class="form-control"><?php echo e($biochemHaemoResults->test_notes ?? ''); ?></textarea>
                                        </td>
                                        <td>
                                            <?php if($index > 0 && !$allTestsCompleted && $profileId == 'no-profile'): ?>
                                                <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                                    data-bs-placement="top" title="Delete">
                                                    <a class="remove-item-btn" data-id="<?php echo e($test->id); ?>"
                                                        data-sampleid="<?php echo e($sample->id); ?>" data-bs-toggle="modal"
                            ...
                            <?php $__currentLoopData = $tests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="reference-range">
                                            <?php if($test->reference_range == 'basic_ref'): ?>
                                                <?php echo e($test->basic_low_value_ref_range . '-' . $test->basic_high_value_ref_range); ?>

                                            <?php elseif($test->reference_range == 'optional_ref'): ?>
                                                Male: <?php echo e($test->male_low_value_ref_range . '-' . $test->male_high_value_ref_range); ?>

                                                <br>
                                                Female: <?php echo e($test->female_low_value_ref_range . '-' . $test->female_high_value_ref_range); ?>
                                    ...
                                    <td>
                                        <?php if($index > 0 && !$allTestsCompleted): ?>
                                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                                data-bs-placement="top" title="Delete">
                                                <a class="remove-item-btn" data-id="<?php echo e($test->id); ?>"
                                                    data-sampleid="<?php echo e($sample->id); ?>" data-bs-toggle="modal"
            ...
            <?php if($reporttype == 2): ?>
                <?php $__currentLoopData = $tests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <input type="hidden" id="test_id" name="test_id[]" value="<?php echo e($testIds); ?>" hidden>
                <div class="card-header py-1">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="last_period" name="last_period"
                                ...
                                value="<?php echo e($cytologyGynecologyResults->last_period ?? ''); ?>" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="js-example-basic-multiple" name="contraceptive" id="Contraceptive">
                                ...
                                <?php $__currentLoopData = $contraceptivedropdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($test->value); ?>"
                                        <?php echo e(!empty($cytologyGynecologyResults) && $cytologyGynecologyResults->contraceptive === $test->value ? 'selected' : ''); ?>>
                                        <?php echo e($test->value); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="history" id="history" cols="30" rows="" class="form-control" value=""><?php echo e($cytologyGynecologyResults->history ?? ''); ?></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="previous_pap" name="previous_pap" class="form-control"
                                value="<?php echo e($cytologyGynecologyResults->previous_pap ?? ''); ?>" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="result1" name="result" class="form-control"
                                value="<?php echo e($cytologyGynecologyResults->result ?? ''); ?>" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="cervix_examination" class="form-label">Cervix Examination </label>
                            <textarea type="text" id="cervix_examination" name="cervix_examination" class="form-control" value=""><?php echo e($cytologyGynecologyResults->cervix_examination ?? ''); ?></textarea>
                        </div>
                    </div>
                </div>
                <div class="card-header py-1">
                ...
                <div class="row pt-3">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <textarea name="specimen_adequacy" id="specimen_adequacy" cols="" rows="5" class="form-control"
                                value=""><?php echo e($cytologyGynecologyResults->specimen_adequacy ?? ''); ?></textarea>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <textarea name="diagnostic_interpretation" id="diagnostic_interpretation" cols="30" rows="5"
                                class="form-control"><?php echo e($cytologyGynecologyResults->diagnostic_interpretation ?? ''); ?></textarea>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <textarea name="recommend" id="recommend" cols="30" rows="5" class="form-control"><?php echo e($cytologyGynecologyResults->recommend ?? ''); ?></textarea>
                ...
                <div class="row pt-3">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="urinalysis_note" id="urinalysis_note" cols="30" rows="5" class="form-control"><?php echo e($department3Status->note ?? ''); ?></textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div>
                                            ...
                                            <div id="procedures-container">
                                                ...
                                                <?php $__currentLoopData = $procedureResults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $procedure): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                                    <div class="procedure-group">
                                                        <div class="form-group">
                                                            <label for="procedure" class="form-label">Procedure</label>
                                                            <input type="text" class="form-control procedure" name="procedure" id="" value="<?php echo e($procedure->procedure); ?>" >
                                                            
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="specimen_note" class="form-label">Note</label>
                                                            <textarea type="text" name="specimen_note[]" rows="5" class="form-control"><?php echo e($procedure->specimen_note); ?></textarea>
                                                        </div>
                                                        <?php if($index > 0): ?>
                                            ...
                                            <form id="profileForm" class="d-flex align-items-center">
                                                ...
                                                <div class="form-group mb-0 mr-2 col-6">
                                                    <label for="profiles" class="mr-2">Select Profiles: <a href=""
                                                        ...
                                                        href="<?php echo e(route('profile.index')); ?>" target="blank"> <span
                                                            class="badge bg-info text-white"> All Items</span> </a></label>
                                                    <select name="profiles[]" id="profiles"
                                                        class="js-example-basic form-control" >
                                                        
                                                        
                                                        <?php $__currentLoopData = $senstivityprofiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $profile): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($profile->id); ?>"
                                                                
                                                                >
                                                                <?php echo e($profile->name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                        ...
                                        <div id="reportContainer" class="mt-3">
                                            ...
                                            <?php if(!empty($sensitivityData)): ?>
                                                <?php $__currentLoopData = $sensitivityData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $profileIndex => $profile): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="sensitivity-group">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="microorganism_<?php echo e($profileIndex); ?>">Microorganism:</label>
                                                            <input type="text" name="microorganism[<?php echo e($profileIndex); ?>]" class="form-control"
                                                                value="<?php echo e($profile->microorganism); ?>">
                                                        </div>
                                                        <table class="table table-bordered">
                                                            <thead>
                                                                <tr>
                                                                    <th>Antibiotics</th>
                                                                    <th><?php echo e(getSensitivityUnitByMicroorganism($profile->microorganism)); ?></th>
                                                                    <th>Sensitive</th>
                                                                    <th>Resistant</th>
                                                                    <th>Intermediate</th>
                                                                </tr>
                                                            ...
                                                            <tbody>
                                                                <?php $__currentLoopData = $profile->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemIndex => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <tr>
                                                                        <td><?php echo e($item->antibiotic); ?></td>
                                                                        <td>
                                                                            <input type="text" name="mic[<?php echo e($profileIndex); ?>][<?php echo e($itemIndex); ?>]"
                                                                                class="form-control" value="<?php echo e($item->mic); ?>">
                                                                        </td>
                                                                        <td>
                                                                            <input type="radio"
                                                                                name="sensitivity[<?php echo e($profileIndex); ?>][<?php echo e($itemIndex); ?>]"
                                                                                value="sensitive"
                                                                                <?php echo e($item->sensitivity === 'sensitive' ? 'checked' : ''); ?>>
                                                                        </td>
                                                                        <td>
                                                                            <input type="radio"
                                                                                name="sensitivity[<?php echo e($profileIndex); ?>][<?php echo e($itemIndex); ?>]"
                                                                                value="resistant"
                                                                                <?php echo e($item->sensitivity === 'resistant' ? 'checked' : ''); ?>>
                                                                        </td>
                                                                        <td>
                                                                            <input type="radio"
                                                                                name="sensitivity[<?php echo e($profileIndex); ?>][<?php echo e($itemIndex); ?>]"
                                                                                value="intermediate"
                                                                                <?php echo e($item->sensitivity === 'intermediate' ? 'checked' : ''); ?>>
                                                                        </td>
                                                                    </tr>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </tbody>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="review" class="form-label">Review
                                                    <?php if(!$sample->is_completed): ?>
                                                    <span class="badge bg-info text-white add-urine-note" data-target="#review"> Add Note</span>
                                                    <?php endif; ?>
                                                </label>
                                                <textarea name="review" id="review" cols="30" rows="5" class="form-control"><?php echo e($sensitivityResult->review ?? ''); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="showModalRefferenceranges" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                ...
                <form class="tablelist-form" id="refRanges_form" action="<?php echo e(url("/uriRefRanges")); ?>" method="Post" autocomplete="off">
                    <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                ...
                <form class="tablelist-form" id="leadtype_form" action="<?php echo e(url("/test")); ?>" method="Post" autocomplete="off">
                    <?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                    ...
                    <div id="sign-form">
                        <p class="text-dark fw-semibold fs-6">Please indicate that you agree with all that is in this
                            report by signing:</p>
                        <form class="tablelist-form" id="leadtype_form" action="<?php echo e(route('test-reports.signReport')); ?>"
    ...
    <div class="modal fade" id="showModalSensitivity" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content border-0">
                ...
                <form class="tablelist-form" id="sensitivity_form_submit" action="<?php echo e(url('/profile')); ?>" method="Post"
                    autocomplete="off">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.add-note').on('click', function() {
                ...
                $.ajax({
                    type: 'GET',
                    url: '<?php echo e(route('fetch-notes-cytology')); ?>',
            ...
            $('.add-urine-note').on('click', function() {
                ...
                $.ajax({
                    type: 'GET',
                    url: '<?php echo e(route('fetch-notes-urinalysis')); ?>',
                    success: function(notes) {
                        var notesContainer = $('#notes-container');
                        notesContainer.empty();
    ...
    <script>
        ...
        jQuery(document).ready(function($) {
            ...
            $('.generate-pdf-link').click(function(e) {
                ...
                var url = "<?php echo e(url('generate-pdf')); ?>/" + testReportId + "/" + reportType;
            ...
            $(document).on('click', '#delete-record', function(event) {
                ...
                var url = '<?php echo e(url('/reports/delink-test')); ?>' + '/' + deleterecordid;
            ...
            $(document).on('click', '#complete-record', function(event) {
                ...
                // var deleterecordid = $('#delete-record-id').val();
                var url = '<?php echo e(url('/reports/complete-test')); ?>';
                // Prevent the default link behavior
                // var reporttypeis = $('#report_type').val();
                data = {
                    sample_id: sampleid,
            ...
            $(document).on('click', '#Uncomplete-record', function(event) {
                ...
                var reporttypeis = $('#reporttypeis').val();
                // var deleterecordid = $('#delete-record-id').val();
                var url = '<?php echo e(url('/reports/uncomplete-test')); ?>';
                // Prevent the default link behavior
                // var reporttypeis = $('#report_type').val();
                data = {
                    sample_id: sampleid,
        ...
        $(document).on('click', '.uriRefRangesEdit', function() {
            ...
            var url = '<?php echo e(url('/uriRefRanges/getvalues')); ?>' + '/' + dropdownName + '/edit';
        ...
        $(document).on('click', '.getcalc', function() {
            ...
            // $('#analyte').val(dropdownName); // Set the dropdown name
            var url = '<?php echo e(url('getcalc')); ?>' + '/' + test_id + '/edit';
        ...
        $('#refRanges_form').submit(function(e) {
            ...
            $.ajax({
                url: '<?php echo e(url('uriRefRanges/store')); ?>',
                method: 'POST',
                data: formData,
                headers: {
        ...
        $('#sign-button').click(function(event) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo e(route('test-reports.signReport')); ?>',
                data: formData,
                dataType: 'json',
                success: function(response) {
                    if (response.success) {
        ...
        $(document).on('click', '#createReportButton', function() {
            ...
            if (selectedProfiles.length > 0) {
                $.ajax({
                    url: '<?php echo e(route('test-reports.getsensitivityitems')); ?>',
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': $('input[name="_token"]').val()
                    },
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/two0/public_html/resources/views/reports/test-reports/edit.blade.php ENDPATH**/ ?>