                    ...
                    <nav class="navbar">
                        <div class="container-fluid p-0">
                            <form class="d-flex" method="GET" action="<?php echo e(route('root')); ?>">
                                ...
                                <form class="d-flex gap-2" method="GET" action="<?php echo e(route('root')); ?>">
                                    ...
                                    <select class="form-select sort-dropdown" aria-label="Default select example" name="entries_shown" onchange="this.form.submit()">
                                        ...
                                        <option value="last_20_days" <?php echo e(request('entries_shown') == 'last_20_days' ? 'selected' : ''); ?>>Last 20 days</option>
                                        <option value="last_3_years" <?php echo e(request('entries_shown') == 'last_3_years' ? 'selected' : ''); ?>>Last 3 years</option>
                                        <option value="all" <?php echo e(request('entries_shown') == 'all' ? 'selected' : ''); ?>>All</option>
                                    </select>
                                    ...
                                    <select class="form-select sort-dropdown" style="" aria-label="Default select example" name="sort_by" onchange="this.form.submit()">
                                        ...
                                        <option value="first_name" <?php echo e(request('sort_by') == 'first_name' ? 'selected' : ''); ?>>Patient Name</option>
                ...
                <table id="" class="table table-striped display table-responsive rounded">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $samples; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sample): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(!$sample->all_departments_completed): ?> <!-- Only show incomplete samples -->
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Sample edit')): ?>
                                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Edit">
                                                <a id="edit-btn" class="edit-item-btn fs-5" data-id="<?php echo e($sample->id); ?>" href="#showModal" data-bs-toggle="modal">
                                                    <img src="<?php echo e(URL::asset('build/images/Vector.png')); ?>" alt="" height="20">
                                                </a>
                                            </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Sample delete')): ?>
                                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Delete">
                                                <a class="remove-item-btn" data-id="<?php echo e($sample->id); ?>" data-bs-toggle="modal" href="#deleteRecordModal">
                                                    <img src="<?php echo e(URL::asset('build/images/delete.png')); ?>" alt="" height="20">
                                                </a>
                                            </li>
                                        <?php endif; ?>
                                    </td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/two0/public_html/resources/views/index.blade.php ENDPATH**/ ?>