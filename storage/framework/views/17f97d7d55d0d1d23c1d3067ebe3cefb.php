                ...
                <div class="col">
                    <div class="card p-3 bg-white">
                        <div class="card-header d-flex justify-content-between">
                            <h3 class="text-dark">List of notes</h3>
                        ...
                        <div class="col my-2">
                            <nav class="navbar">
                                <div class="container-fluid p-0">
                                    <form class="d-flex" method="GET" action="<?php echo e(route('note.index')); ?>">
                                    ...
                                    <form class="d-flex" method="GET" action="<?php echo e(route('note.index')); ?>">
                                        ...
                                        <select class="form-select sort-dropdown" aria-label="Default select example"
                                            ...
                                            <option value="note_code"
                                                <?php echo e(request('sort_by') == 'note_code' ? 'selected' : ''); ?>>NoteCode</option>
                                            <option value="department"
                                                <?php echo e(request('sort_by') == 'department' ? 'selected' : ''); ?>>Department
                                            </option>
                                            <option value="comment"
                                                <?php echo e(request('sort_by') == 'comment' ? 'selected' : ''); ?>>Comment
                                            </option>
                                        </select>
                                    </form>
                                </div>
                        ...
                        <table id="" class="table table-striped display table-responsive rounded">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $notes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($note->note_code); ?></td>
                                        <td>
                                            <?php if($note->department == 1): ?>    
                                                Biochemistry / Haematology
                                            <?php elseif($note->department == 2): ?>
                                                Cytology / Gynecology
                                            <?php elseif($note->department == 3): ?>
                                                Urinalysis / Microbiology
                                            <?php else: ?>
                                                Unknown Department
                                            <?php endif; ?>
                                        </td>
                                        <td><?php echo e($note->comment); ?></td>
                                        <td><?php echo e($note->is_active == 1 ? 'Active' : 'InActive'); ?></td>
                                        ...
                                        <td>
                                            <ul class="list-inline hstack gap-2 mb-0">
                                                <li class="list-inline-item" data-bs-toggle="tooltip"
                                                    ...
                                                    <a class="edit-item-btn" data-id="<?php echo e($note->id); ?>"  href="#showModal" data-bs-toggle="modal"><i
                                                            class="ri-pencil-fill align-bottom text-muted"></i></a>
                                                </li>
                                                <li class="list-inline-item" data-bs-toggle="tooltip"
                                                    data-bs-trigger="hover" data-bs-placement="top" title="Delete">
                                                    <a class="remove-item-btn" data-id="<?php echo e($note->id); ?>"  data-bs-toggle="modal"
                        ...
                        <ul class="pagination justify-content-center">
                            <?php if($notes->previousPageUrl()): ?>
                                <li class="page-item previousPageUrl">
                                    <a class="page-link" href="<?php echo e($notes->previousPageUrl()); ?>" aria-label="Previous">
                            ...
                            <?php for($page = 1; $page <= $notes->lastPage(); $page++): ?>
                                <li class="page-item <?php echo e($notes->currentPage() == $page ? 'active' : ''); ?>">
                                    <a class="page-link"
                                        href="<?php echo e($notes->url($page)); ?>"><?php echo e(str_pad($page, 2, '0', STR_PAD_LEFT)); ?></a>
                                </li>
                            <?php endfor; ?>

                            <?php if($notes->nextPageUrl()): ?>
                                <li class="page-item nextPageUrl">
                                    <a class="page-link" href="<?php echo e($notes->nextPageUrl()); ?>" aria-label="Next">
    ...
    <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                ...
                <form class="tablelist-form" id="leadtype_form" action="<?php echo e(url("/note")); ?>" method="Post" autocomplete="off">
                    <?php echo csrf_field(); ?>
                            ...
                            <div class="col-lg-6">
                                <div>
                                    <label for="companyname-field"
                                        class="form-label">Note Code</label>
                                    <input type="text" id="note_code" name="note_code"
                                        class="form-control"
                                        placeholder="Enter Note Code" required />
                                </div>
                    ...
                    <div class="modal-footer">
                        <div class="hstack gap-2 justify-content-end">
                            ...
                            <button type="submit" class="btn btn-success" id="add-btn">Add Note</button>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-5 text-center">
                    ...
                    <div class="mt-4 text-center">
                        <h4 class="fs-semibold">You are about to delete a Note ?</h4>
                        <p class="text-muted fs-14 mb-4 pt-1">Deleting your Note will
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        $('.edit-item-btn').on('click', function() {
            ...
            var url = '<?php echo e(url("/note")); ?>' + '/' + itemId + '/edit';
            ...
            $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#note_code').val(note.note_code);
                        $('#department').val(note.department);
                        ...
                        $('#leadtype_form').attr('action', '<?php echo e(url("/note")); ?>/' + itemId);
        ...
        function resetModal() {
            // Reset modal titleq
            $('#exampleModalLabel').html("Add Note");
            ...
            // Change the button text
            $('#add-btn').html("Add");
            $('#leadtype_form').attr('action', '<?php echo e(url("/note")); ?>');
            // if ( $('#patch').length) {
            //     $('#patch').remove();
            // }
            $('#note_code').val('');
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/two0/public_html/resources/views/setup/notes.blade.php ENDPATH**/ ?>