            ...
            <div class="col">
                <div class="card p-3 bg-white">
                    ...
                    <div class="col my-2">
                        <nav class="navbar">
                            <div class="container-fluid p-0">
                                <form class="d-flex" method="GET" action="<?php echo e(route('profile.index')); ?>">
                                ...
                                <form class="d-flex" method="GET" action="<?php echo e(route('profile.index')); ?>">
                                    ...
                                    <select class="form-select sort-dropdown" aria-label="Default select example"
                                        ...
                                        <option value="name" <?php echo e(request('sort_by') == 'name' ? 'selected' : ''); ?>>Name
                                        </option>
                                    ...
                                    <td>
                                        <ul class="list-inline hstack gap-2 mb-0">
                                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                                ...
                                                <a class="edit-item-btn" data-id="<?php echo e($profile->id); ?>" href="#showModal"
                                                    data-bs-toggle="modal"><i
                                                        class="ri-pencil-fill align-bottom text-muted"></i></a>
                                            </li>
                                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                                data-bs-placement="top" title="Delete">
                                                <a class="remove-item-btn" data-id="<?php echo e($profile->id); ?>"
                    ...
                    <ul class="pagination justify-content-center">
                        <?php if($profiles->previousPageUrl()): ?>
                            <li class="page-item previousPageUrl">
                                <a class="page-link" href="<?php echo e($profiles->previousPageUrl()); ?>" aria-label="Previous">
                        ...
                        <?php for($page = 1; $page <= $profiles->lastPage(); $page++): ?>
                            <li class="page-item <?php echo e($profiles->currentPage() == $page ? 'active' : ''); ?>">
                                <a class="page-link"
                                    href="<?php echo e($profiles->url($page)); ?>"><?php echo e(str_pad($page, 2, '0', STR_PAD_LEFT)); ?></a>
                            </li>
                        <?php endfor; ?>

                        <?php if($profiles->nextPageUrl()): ?>
                            <li class="page-item nextPageUrl">
                                <a class="page-link" href="<?php echo e($profiles->nextPageUrl()); ?>" aria-label="Next">
    ...
    <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content border-0">
                ...
                <form class="tablelist-form" id="leadtype_form" action="<?php echo e(url('/profile')); ?>" method="Post"
                    autocomplete="off">
    ...
    <script>
        ...
        jQuery(document).ready(function($) {
            ...
            $('.edit-item-btn').on('click', function() {
                ...
                var url = '<?php echo e(url('/profile')); ?>' + '/' + itemId + '/edit';
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#leadtype_form').attr('action', '<?php echo e(url('/profile')); ?>/' + itemId);
            ...
            function resetModal() {
                ...
                // Change the button text
                $('#add-btn').html("Add");
                $('#leadtype_form').attr('action', '<?php echo e(url('/profile')); ?>');
                // if ( $('#patch').length) {
                //     $('#patch').remove();
                // }
                $('#id-field').val('');
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/two0/public_html/resources/views/setup/senstivity.blade.php ENDPATH**/ ?>