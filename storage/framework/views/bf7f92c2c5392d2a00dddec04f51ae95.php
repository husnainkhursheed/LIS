                    ...
                    <div class="collapse menu-dropdown" id="sidebarSetup">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any('TestCharges access')): ?>
                                <li class="nav-item">
                                    <a href="<?php echo e(url('/test')); ?>" class="nav-link px-0 py-2">Charges and Reference
                                        Ranges</a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(url('/TestProfile')); ?>" class="nav-link px-0 py-2">Test Profiles</a>
                                </li>
                            ...
                            <?php endif; ?>
                            <li class="nav-item">
                                <a href="<?php echo e(url('/settings')); ?>" class="nav-link px-0 py-2">Settings</a>
                            </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarreport">
                            <ul class="nav nav-sm flex-column">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any('Manage TestReports')): ?>
                                    <li class="nav-item">
                                        <a href="<?php echo e(url('/reports/test-reports?sort_by=access_number')); ?>" class="nav-link">Test Reports</a>
                                    </li>
                                <?php endif; ?>
                                <li class="nav-item">
                                    <a href="<?php echo e(url('/reports/processing-time')); ?>" class="nav-link">Processing Time</a>
                                </li>
                            	<li class="nav-item">
                                    <a href="<?php echo e(url('/reports/master-report')); ?>" class="nav-link">Master Report</a>
                                </li>
...
<?php /**PATH /home/two0/public_html/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>