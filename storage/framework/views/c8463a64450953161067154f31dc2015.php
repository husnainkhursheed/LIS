            ...
            <form class="mb-4" action="<?php echo e(route('test-reports.index')); ?>" method="GET">
                <div class="row d-flex align-items-end">
                    ...
                    <div class="col-2">
                        ...
                        <input type="date" name="dob" id="dob" value="<?php echo e(request('dob')); ?>" class="form-control">
                    </div>
                    ...
                    <div class="col-2">
                        <select class="form-select sort-dropdown" style="" aria-label="Default select example" name="sort_by" onchange="this.form.submit()">
                            ...
                            <option value="patient_name" <?php echo e(request('sort_by') == 'patient_name' ? 'selected' : ''); ?>>Patient Name</option>
                        </select>
                    </div>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $testReports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testReport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <form action="<?php echo e(url('/reports/test-reports', $testReport->id)); ?>" id="edittestreport<?php echo e($testReport->id); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <select class="test-reports-dropdown" name="report_type" id="report_type" required>
                                                        
                                                        
                                                        <?php $__currentLoopData = $testReport->unique_departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($department); ?>"><?php if($department == 1): ?>
                                                                Biochemistry / Haematology
                                                            <?php elseif($department == 2): ?>
                                                                Cytology / Gynecology
                                                            <?php elseif($department == 3): ?>
                                            ...
                                            <td><?php $__currentLoopData = $testReport->unique_departments_status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $departmentStatus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div>
                                                    <?php switch($index):
                                                        ...
                                                        <?php default: ?>
                                                            Unknown Department
                                                    <?php endswitch; ?>:
                                                    <?php echo $departmentStatus['is_completed']
                                            ...
                                            <td>
                                                <ul class="list-inline hstack gap-2 mb-0">
                                                    <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Generate PDF">
                                                        <a href="#" class="generate-pdf-link" data-test-report-id="<?php echo e($testReport->id); ?>">
                                                            <span class="logo-sm">
                                                                <img src="<?php echo e(URL::asset('build/images/report.png')); ?>" alt="" height="20">
                                                            </span>
                                                        </a>
                                                    </li>
                                                    <li class="list-inline-item" data-bs-toggle="tooltip"
                                                        data-bs-trigger="hover" data-bs-placement="top" title="Edit">
                                                        <a class="edit-item-btn" data-id="<?php echo e($testReport->id); ?>"  href="#" ><i
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        $('.edit-item-btn').on('click', function() {
            ...
            // var itemId = $(this).data('id');
            // var url = '<?php echo e(url("/reports/test-reports")); ?>';
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/two0/public_html/resources/views/reports/test-reports/index.blade.php ENDPATH**/ ?>