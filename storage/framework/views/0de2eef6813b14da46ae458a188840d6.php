                            ...
                            <table id="" class="table table-striped display table-responsive rounded">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($record->user->first_name); ?></td>
                                        <td><?php echo e($record->changed_at); ?></td>
                                        <td>
                                            <ul class="list-inline hstack gap-2 mb-0">
                                                <li class="list-inline-item" data-bs-toggle="tooltip"
                                                    data-bs-trigger="hover" data-bs-placement="top" title="Edit">
                                                    <a class="edit-item-btn" data-id="<?php echo e($record->test_report_id); ?>" data-changedat="<?php echo e($record->changed_at); ?>"  href="#showModal" data-bs-target="#auditModal" data-bs-toggle="modal"><i
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        $('.edit-item-btn').on('click', function() {
            ...
            // console.log(itemId);
            var url = '<?php echo e(url('reports/changes')); ?>' + '/' + itemId ;
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/two0/public_html/resources/views/reports/test-reports/auditTraits.blade.php ENDPATH**/ ?>