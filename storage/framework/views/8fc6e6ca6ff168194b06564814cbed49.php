                        ...
                        <ul class="pagination justify-content-center">
                            <?php if($tests->previousPageUrl()): ?>
                                <li class="page-item previousPageUrl">
                                    <a class="page-link" href="<?php echo e($tests->previousPageUrl()); ?>" aria-label="Previous">
                            ...
                            <?php for($page = 1; $page <= $tests->lastPage(); $page++): ?>
                                <li class="page-item <?php echo e($tests->currentPage() == $page ? 'active' : ''); ?>">
                                    <a class="page-link"
                                        href="<?php echo e($tests->url($page)); ?>"><?php echo e(str_pad($page, 2, '0', STR_PAD_LEFT)); ?></a>
                                </li>
                            <?php endfor; ?>

                            <?php if($tests->nextPageUrl()): ?>
                                <li class="page-item nextPageUrl">
                                    <a class="page-link" href="<?php echo e($tests->nextPageUrl()); ?>" aria-label="Next">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\LIS\LIS\resources\views/setup/tests.blade.php ENDPATH**/ ?>