                        ...
                        <div class="col my-2">
                            <nav class="navbar">
                                <div class="container-fluid p-0">
                                    <form class="d-flex" method="GET" action="<?php echo e(route('TestProfile.index')); ?>">
                                    ...
                                    <form class="d-flex" method="GET" action="<?php echo e(route('TestProfile.index')); ?>">
                                        ...
                                        <select class="form-select sort-dropdown" aria-label="Default select example"
                                            ...
                                            <option value="code"
                                                <?php echo e(request('sort_by') == 'code' ? 'selected' : ''); ?>>Code</option>
                                            <option value="name"
                                                <?php echo e(request('sort_by') == 'name' ? 'selected' : ''); ?>>Name
                                            </option>
                                            <option value="specimen_type"
                                                <?php echo e(request('sort_by') == 'specimen_type' ? 'selected' : ''); ?>>Specimen Type
                                            </option>
                                        </select>
                                    </form>
                                </div>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $notes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo e($note->name); ?>

                                        </td>
                                        <td><?php echo e($note->cost); ?></td>
                                        <td>
    ...
    <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                ...
                <form class="tablelist-form" id="leadtype_form" action="<?php echo e(url("/TestProfile")); ?>" method="Post" autocomplete="off">
                    <?php echo csrf_field(); ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        $('.edit-item-btn').on('click', function() {
            ...
            var url = '<?php echo e(url("/TestProfile")); ?>' + '/' + itemId + '/edit';
            ...
            $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#leadtype_form').attr('action', '<?php echo e(url("/TestProfile")); ?>/' + itemId);
        ...
        function resetModal() {
            ...
            // Change the button text
            $('#add-btn').html("Add");
            $('#leadtype_form').attr('action', '<?php echo e(url("/TestProfile")); ?>');
            // if ( $('#patch').length) {
            //     $('#patch').remove();
            // }
            $('#code').val('');
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/two0/public_html/resources/views/setup/testProfiles.blade.php ENDPATH**/ ?>