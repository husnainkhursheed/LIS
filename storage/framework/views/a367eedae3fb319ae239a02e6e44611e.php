...
<body>
    ...
    <div class="container">
        <div class="content">
            <p> <b>Good Day</b> <?php echo e($first_name); ?> <?php echo e($surname); ?>,</p>
            <p>Your account has been created, you need to click on the link below to set up your password and 2FA:</p>
            <a href="<?php echo e(url('verify', $token)); ?>">Create Password</a>
        </div>
        <div class="footer">
...
<?php /**PATH /home/two0/public_html/resources/views/emails/verify.blade.php ENDPATH**/ ?>