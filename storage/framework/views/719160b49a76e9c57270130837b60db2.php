    ...
    <div class="row">
        ...
        <div class="card py-3 bg-white">
            <div class="card-header d-flex justify-content-between mb-4 py-2">
                <h3 class="text-dark">Master Report</h3>
            </div>
            <form class="mb-4" action="<?php echo e(route('masterreport.index')); ?>" method="GET">
                <div class="row d-flex align-items-end">
                    <div class="col-3">
                        <label for="date_from">Date From</label>
                        <input type="date" name="date_from" id="date_from" value="<?php echo e(old('start_date')); ?>"
                            class="form-control">
                    </div>
                    <div class="col-3">
                        <label for="date_to">Date To</label>
                        <input type="date" name="date_to" id="date_to" value="<?php echo e(old('end_date')); ?>"
                            class="form-control">
                    </div>
                    <div class="col-2">
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            var currentUser =
                "<?php echo e(Auth::user()->getRoleNames()->first()); ?>"; // Get the current user's ID from the server-side
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/two0/public_html/resources/views/reports/reporting&analytics/masterreport.blade.php ENDPATH**/ ?>