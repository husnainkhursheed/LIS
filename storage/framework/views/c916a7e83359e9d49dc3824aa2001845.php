        ...
        <div class="col-lg-12">
                ...
                <div class="col">
                    <div class="card p-3 bg-white">
                        ...
                        <div class="col my-2">
                            <nav class="navbar">
                                <div class="container-fluid p-0">
                                    <form class="d-flex" method="GET" action="<?php echo e(route('test.index')); ?>">
                                    ...
                                    <form class="d-flex" method="GET" action="<?php echo e(route('test.index')); ?>">
                                        ...
                                        <select class="form-select sort-dropdown" aria-label="Default select example"
                                            ...
                                            <option value="cost"
                                                <?php echo e(request('sort_by') == 'cost' ? 'selected' : ''); ?>>Cost
                                            </option>
                                        </select>
                                    </form>
                                </div>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $tests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($test->is_active == 1 ? 'Active' : 'InActive'); ?></td>
                        ...
                        <?php if($tests->previousPageUrl()): ?>
                            <li class="page-item previousPageUrl">
                                <a class="page-link" href="<?php echo e($tests->appends(request()->except('page'))->previousPageUrl()); ?>" aria-label="Previous">
                        ...
                        <?php for($page = 1; $page <= $tests->lastPage(); $page++): ?>
                            <li class="page-item <?php echo e($tests->currentPage() == $page ? 'active' : ''); ?>">
                                <a class="page-link"
                                    href="<?php echo e($tests->appends(request()->except('page'))->url($page)); ?>"><?php echo e(str_pad($page, 2, '0', STR_PAD_LEFT)); ?></a>
                            </li>
                        <?php endfor; ?>

                        <?php if($tests->nextPageUrl()): ?>
                            <li class="page-item nextPageUrl">
                                <a class="page-link" href="<?php echo e($tests->appends(request()->except('page'))->nextPageUrl()); ?>" aria-label="Next">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6" id="urin_test_type_container">
                                <div>
                                    <label for="urin_test_type" class="form-label">Urinalysis Category</label>
                            ...
                            <div class="col-lg-6">
                                ...
                                > <span class="badge bg-info text-white"> Add New</span> </a></label>
                                    ...
                                    <select class="js-example-basic-multiple form-control" name="specimen_type" id="specimen_type">
                                        <?php $__currentLoopData = $specimen_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specimen_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                            <option value="<?php echo e($specimen_type->id); ?>">
                                                <?php echo e($specimen_type->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
     ...
     aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                ...
                <form class="tablelist-form" id="specimen_type_form" action="<?php echo e(url('/specimen-types')); ?>" method="POST" autocomplete="off">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <input type="hidden" id="id-field" />
                        <div class="row g-3">
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        $('.edit-item-btn').on('click', function() {
            ...
            var url = '<?php echo e(url("/test")); ?>' + '/' + itemId + '/edit';
            ...
            $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.testProfiles) {
                            ...
                            $('#test_profiles').val(response.testProfiles.id);
                        }
                        ...
                        $('#leadtype_form').attr('action', '<?php echo e(url("/test")); ?>/' + itemId);
        ...
        function resetModal() {
            ...
            $('#showModal .modal-footer').css('display', 'block');
            $('#add-btn').html("Add");
            $('#leadtype_form').attr('action', '<?php echo e(url("/test")); ?>');
            $('#name').val('');
            $('#department').val('');
            $('#specimen_type ').val('');
            $('#cost').val('');
        ...
        $('#specimen_type_form').on('submit', function(e) {
            ...
            $.ajax({
                url: '<?php echo e(url("/specimen-types")); ?>',
                method: 'POST',
                data: $(this).serialize(),
                success: function(response) {
                    if (response.success) {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/two0/public_html/resources/views/setup/tests.blade.php ENDPATH**/ ?>